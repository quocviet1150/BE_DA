...
public class AccountServiceImpl implements AccountService {
    ...
    @Override
    @Transactional
    public void createNewAccountAfterOAuthLoginSuccess(String email, String password, String name,
    ...
    @Override
    public void updateAccountAfterOAuthLoginSuccess(String email, String name, Account account,
                                                    AuthenticationProvider provider) {
        account.setLastName(name);
        account.setAuthProvider(provider);
